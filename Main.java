...
Критерии фильтрации можно хранить в Map. Например: “Введите цифру, соответствующую 
...
public class Main {
    public static void main(String[] args) {
        ...
        Notebook note11 = new Notebook("Lenovo", "LEG77", "black", 16.2f, 256, 8, "Windows", 97000);
        Notebook note12 = new Notebook("ASUS", "ASUS2", "white", 15.6f, 128, 4, "Windows", 72000);
